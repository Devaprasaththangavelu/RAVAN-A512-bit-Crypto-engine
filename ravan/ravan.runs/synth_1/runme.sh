...
HD_PWD='D:/ravan crypto/ravan/ravan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ravan_axi_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ravan_axi_top.tcl
