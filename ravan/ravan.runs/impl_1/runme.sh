...
HD_PWD='D:/ravan crypto/ravan/ravan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ravan_axi_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ravan_axi_top.tcl -notrace
